...
@Entity
@Table(schema = "product", name = "product_price_components")
public class ProductPriceComponents extends BaseEntity {
    @Id
    @Column(name = "id")
    @SequenceGenerator(name = "product_price_component_seq", sequenceName = "product.product_price_components_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_price_component_seq")
    private Long id;
