...
@AllArgsConstructor
@NoArgsConstructor
public class TermsViewResponse {
    ...
    public TermsViewResponse(Terms terms, List<InvoicePaymentTermsResponse> invoicePaymentTerms) {
        this.id = terms.getId();
    ...
    public TermsViewResponse(Terms terms, List<InvoicePaymentTermsResponse> invoicePaymentTerms, boolean isLocked) {
        this.id = terms.getId();
        this.name = terms.getName();
        this.contractDeliveryActivationValue = terms.getContractDeliveryActivationValue();
        this.contractDeliveryActivationType = terms.getContractDeliveryActivationType();
