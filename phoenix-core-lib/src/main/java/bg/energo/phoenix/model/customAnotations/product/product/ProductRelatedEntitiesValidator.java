...
@Documented
@Constraint(validatedBy = {ProductRelatedEntitiesValidator.ProductRelatedEntitiesValidatorImpl.class})
public @interface ProductRelatedEntitiesValidator {
    ...
    class ProductRelatedEntitiesValidatorImpl implements ConstraintValidator<ProductRelatedEntitiesValidator, List<ProductRelatedEntityRequest>> {
        @Override
        public boolean isValid(List<ProductRelatedEntityRequest> relatedEntities, ConstraintValidatorContext context) {
            ...
            for (int i = 0; i < relatedEntities.size(); i++) {
                ...
                ProductObligatory obligatory = relatedEntity.getObligatory();
                if (obligatory == null) {
                ...
                ProductAllowSalesUnder allowSalesUnder = relatedEntity.getAllowSalesUnder();
