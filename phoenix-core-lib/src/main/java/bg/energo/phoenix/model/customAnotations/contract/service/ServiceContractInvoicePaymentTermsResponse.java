...
@NoArgsConstructor
@Builder
public class ServiceContractInvoicePaymentTermsResponse {
    private Long id;
    private String name;
    ...
    public ServiceContractInvoicePaymentTermsResponse(InvoicePaymentTerms invoicePaymentTerms, Calendar calendar) {
