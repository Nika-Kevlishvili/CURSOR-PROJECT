...
@Table(schema = "service", name = "service_termination_groups")
public class ServiceTerminationGroup extends BaseEntity {
    ...
    public ServiceTerminationGroup(ServiceDetails serviceDetails, TerminationGroup terminationGroup, ServiceSubobjectStatus status) {
        this.serviceDetails = serviceDetails;
        this.terminationGroup = terminationGroup;
        this.status = status;
    }
}
