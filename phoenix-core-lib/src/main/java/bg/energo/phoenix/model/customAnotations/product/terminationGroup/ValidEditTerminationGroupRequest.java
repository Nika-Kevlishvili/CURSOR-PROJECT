package bg.energo.phoenix.model.customAnotations.product.terminationGroup;
...
@Documented
@Constraint(validatedBy = {ValidEditTerminationGroupRequest.EditTerminationGroupRequestValidator.class})
public @interface ValidEditTerminationGroupRequest {
    ...
    class EditTerminationGroupRequestValidator implements ConstraintValidator<ValidEditTerminationGroupRequest, EditTerminationGroupRequest> {

        @Override
        public boolean isValid(EditTerminationGroupRequest request, ConstraintValidatorContext context) {
