...
@Entity
@Table(schema = "product", name = "product_grid_operators")
public class ProductGridOperator extends BaseEntity {
    @Id
    @Column(name = "id")
    @SequenceGenerator(name = "product_grid_operators_seq", sequenceName = "product.product_grid_operators_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_grid_operators_seq")
    private Long id;
