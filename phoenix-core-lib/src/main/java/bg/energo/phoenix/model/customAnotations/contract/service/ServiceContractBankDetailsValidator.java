...
@Documented
@Constraint(validatedBy = {ServiceContractBankDetailsValidator.ServiceContractBankDetailsValidatorImpl.class})
public @interface ServiceContractBankDetailsValidator {
    ...
    class ServiceContractBankDetailsValidatorImpl implements ConstraintValidator<ServiceContractBankDetailsValidator, ServiceContractBankingDetails> {
        @Override
        public boolean isValid(ServiceContractBankingDetails bankingDetails, ConstraintValidatorContext context) {
