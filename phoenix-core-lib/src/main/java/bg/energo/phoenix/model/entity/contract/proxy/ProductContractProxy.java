...
@Table(schema = "product_contract", name = "contract_proxies")
public class ProductContractProxy extends BaseEntity {
    @Id
    @SequenceGenerator(
            name = "product_contract_proxies_seq",
            sequenceName = "product_contract.contract_proxies_id_seq",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "product_contract_proxies_seq"
    )
    private Long id;
