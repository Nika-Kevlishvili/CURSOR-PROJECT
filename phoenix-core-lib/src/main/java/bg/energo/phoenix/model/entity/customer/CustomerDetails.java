...
public class CustomerDetails extends BaseEntity {
    ...
    public String toString() {
        return "CustomerDetails{" +
                "id=" + id +
                ", oldCustomerNumbers='" + oldCustomerNumbers + '\'' +
                ", vatNumber='" + vatNumber + '\'' +
                ", name='" + name + '\'' +
                ", nameTransl='" + nameTransl + '\'' +
                ", legalFormId=" + legalFormId +
                ", legalFormTranslId=" + legalFormTranslId +
                ", ownershipFormId=" + ownershipFormId +
                ", economicBranchCiId=" + economicBranchCiId +
                ", economicBranchNceaId=" + economicBranchNceaId +
                ", mainActivitySubject='" + mainActivitySubject + '\'' +
                ", publicProcurementLaw=" + publicProcurementLaw +
                ", customerDeclaredConsumption='" + customerDeclaredConsumption + '\'' +
                ...
                ", residentialAreaType=" + residentialAreaType +
                ", districtId=" + districtId +
                ", regionForeign='" + regionForeign + '\'' +
                ", municipalityForeign='" + municipalityForeign + '\'' +
                ", populatedPlaceForeign='" + populatedPlaceForeign + '\'' +
                ", zipCodeForeign='" + zipCodeForeign + '\'' +
                ", districtForeign='" + districtForeign + '\'' +
                ", customerId=" + customerId +
                ", versionId=" + versionId +
                ", marketingCommConsent=" + marketingCommConsent +
                ", foreignEntityPerson=" + foreignEntityPerson +
                ", directDebit=" + directDebit +
                ", foreignAddress=" + foreignAddress +
                ", populatedPlaceId=" + populatedPlaceId +
                ", countryId=" + countryId +
                ", middleName='" + middleName + '\'' +
                ", middleNameTransl='" + middleNameTransl + '\'' +
                ", lastName='" + lastName + '\'' +
                ", lastNameTransl='" + lastNameTransl + '\'' +
                ", businessActivityName='" + businessActivityName + '\'' +
                ", businessActivityNameTransl='" + businessActivityNameTransl + '\'' +
                ", gdprRegulationConsent=" + gdprRegulationConsent +
                ", status=" + status +
                ", streetForeign='" + streetForeign + '\'' +
                ", ResidentialAreaForeign='" + ResidentialAreaForeign + '\'' +
                ", businessActivity=" + businessActivity +
                ", streetTypeForeign=" + streetTypeForeign +
                ", residentialAreaTypeForeign=" + residentialAreaTypeForeign +
                '}';
    }
}
