...
@AllArgsConstructor
@NoArgsConstructor
public class ServiceContractBasicParametersCreateRequest {
    ...
    //@NotNull(message = "serviceContractBasicParametersCreateRequest.signInDate-[signInDate] is mandatory;")
    private LocalDate signInDate;


    //@NotNull(message = "serviceContractBasicParametersCreateRequest.entryIntoForceDate-[entryIntoForceDate] is mandatory;")
