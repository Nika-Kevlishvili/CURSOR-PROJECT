...
import bg.energo.phoenix.model.customAnotations.contract.interestRate.InterestRateEditPeriodsValidator;
import bg.energo.phoenix.model.customAnotations.contract.interestRate.InterestRateEditValidPeriodicityValidator;
...
@AllArgsConstructor
@NoArgsConstructor
@InterestRateEditPeriodsValidator
@InterestRateEditValidPeriodicityValidator
public class InterestRateEditRequest {
    ...
    @DecimalMin(value = "0.01", message = "minAmountOfInterestInPercentOfLiability-[MinAmountOfInterestInPercentOfLiability] should be more than 0.01;")
    ...
    @DecimalMin(value = "0.01", message = "maxAmountOfInterestInPercentOfTheLiability-[MaxAmountOfInterestInPercentOfTheLiability] should be more than 0.01;")
    ...
    private List<@Valid InterestRatePeriodsEditRequest> interestRatePeriods;
    //SubObjects
    @NotNull(message = "paymentTerm-[Payment Term] Must not be null;")
    private @Valid InterestRatePaymentTermEditRequest paymentTerm;
}
