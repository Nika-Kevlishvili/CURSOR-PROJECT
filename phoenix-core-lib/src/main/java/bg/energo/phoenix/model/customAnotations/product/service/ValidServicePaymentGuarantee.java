...
@Documented
@Constraint(validatedBy = {ValidServicePaymentGuarantee.ServicePaymentGuaranteeValidator.class})
public @interface ValidServicePaymentGuarantee {
    ...
    class ServicePaymentGuaranteeValidator implements ConstraintValidator<ValidServicePaymentGuarantee, ServiceBasicSettingsRequest> {
