...
@Documented
@Constraint(validatedBy = {ValidExpressContractBankingDetails.ValidExpressContractBankingDetailsImpl.class})
public @interface ValidExpressContractBankingDetails {
    ...
    class ValidExpressContractBankingDetailsImpl implements ConstraintValidator<ValidExpressContractBankingDetails, ExpressContractBankingDetails> {

        @Override
        public boolean isValid(ExpressContractBankingDetails bankingDetails, ConstraintValidatorContext context) {
