...
@Constraint(validatedBy = {EditDateRangesValidator.EditDateRangesValidatorImpl.class})
public @interface EditDateRangesValidator {
    ...
    class EditDateRangesValidatorImpl implements ConstraintValidator<EditDateRangesValidator, List<EditPeriodOfYearRequest>> {
         ...
         */
        @Override
        public boolean isValid(List<EditPeriodOfYearRequest> periodOfYears, ConstraintValidatorContext context) {
            boolean result = true;
         ...
         */
        private boolean rangesFormatIsValid(List<EditPeriodOfYearRequest> periodOfYears, ConstraintValidatorContext context) {
            boolean result = true;
            for (EditPeriodOfYearRequest periodOfYear : periodOfYears) {
