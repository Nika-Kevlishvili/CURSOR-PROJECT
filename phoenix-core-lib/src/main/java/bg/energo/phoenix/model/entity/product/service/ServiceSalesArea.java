...
@Entity
@Table(schema = "service", name = "service_sales_areas")
public class ServiceSalesArea extends BaseEntity {

    @Id
    @Column(name = "id")
    @SequenceGenerator(
            name = "service_sales_areas_id_seq",
            sequenceName = "service.service_sales_areas_id_seq",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "service_sales_areas_id_seq"
    )
    private Long id;
