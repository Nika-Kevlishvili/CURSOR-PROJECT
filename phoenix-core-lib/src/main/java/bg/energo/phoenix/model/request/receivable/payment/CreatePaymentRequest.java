...
public class CreatePaymentRequest {
    ...
    @NotNull(message = "paymentDate-PaymentDate should not be null;")
    @DateRangeValidator(fieldPath = "paymentDate", fromDate = "1990-01-01", toDate = "2090-12-31")
    private LocalDate paymentDate;

    @NotNull(message = "initialAmount-Initial amount should not be null;")
    ...
    @NotNull(message = "collectionChannelId-CollectionChannelId should not be null;")
    private Long collectionChannelId;

    @NotNull(message = "paymentPackageId-PaymentPackageId should not be null;")
    ...
    @NotNull(message = "customerId-CustomerId should not be null;")
    ...
    private Boolean fromPaymentCancel;
}
