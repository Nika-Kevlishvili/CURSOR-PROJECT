...
@Documented
@Constraint(validatedBy = SystemMessageEditRequestValidator.SystemMessageEditRequestImpl.class)
public @interface SystemMessageEditRequestValidator {
    ...
    class SystemMessageEditRequestImpl implements ConstraintValidator<SystemMessageEditRequestValidator, SystemMessageEditRequest> {
        @Override
        public boolean isValid(SystemMessageEditRequest request, ConstraintValidatorContext context) {
