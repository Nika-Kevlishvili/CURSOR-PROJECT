...
@Documented
@Constraint(validatedBy = CreateCustomerLegalFormValidator.LegalFormValidatorImpl.class)
public @interface CreateCustomerLegalFormValidator {
    ...
    class LegalFormValidatorImpl implements ConstraintValidator<CreateCustomerLegalFormValidator, CreateCustomerRequest> {
        @Override
