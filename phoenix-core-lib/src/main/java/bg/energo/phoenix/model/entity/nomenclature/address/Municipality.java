...
@Table(name = "municipalities", schema = "nomenclature")
public class Municipality extends BaseEntity {
    @Id
    @Column(name = "id")
    @SequenceGenerator(
            name = "municipalities_seq",
            sequenceName = "nomenclature.municipalities_id_seq",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "municipalities_seq"
    )
    private Long id;
    ...
    public Municipality(MunicipalityRequest request) {
