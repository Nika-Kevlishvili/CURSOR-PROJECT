...
@Data
public class DisconnectionPowerSupplyListingRequest {
    ...
    private DisconnectionPowerSupplyListingListColumns sortBy;

    private DisconnectionPowerSupplyListingSearchByEnums searchBy;
    ...
    private List<PowerSupplyDisconnectionStatus> disconnectionStatuses;
