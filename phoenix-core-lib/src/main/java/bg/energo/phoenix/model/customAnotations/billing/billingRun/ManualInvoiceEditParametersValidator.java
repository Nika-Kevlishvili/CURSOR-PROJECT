...
@Constraint(validatedBy = ManualInvoiceEditParametersValidator.ManualInvoiceEditParametersValidatorImpl.class)
public @interface ManualInvoiceEditParametersValidator {
    ...
    class ManualInvoiceEditParametersValidatorImpl implements ConstraintValidator<ManualInvoiceEditParametersValidator, ManualInvoiceEditParameters> {
        @Override
        public boolean isValid(ManualInvoiceEditParameters manualInvoiceParameters, ConstraintValidatorContext context) {
        ...
        private void validateDetailedDataParameters(ManualInvoiceEditParameters manualInvoiceParameters, StringBuilder validationMessages) {
            ManualInvoiceSummaryDataEditParameters summaryDataParameters = manualInvoiceParameters.getManualInvoiceSummaryDataParameters();
            ManualInvoiceDetailedDataEditParameters detailedDataParameters = manualInvoiceParameters.getManualInvoiceDetailedDataParameters();
