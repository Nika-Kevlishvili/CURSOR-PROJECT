...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "contract_files", schema = "service_contract")
public class ServiceContractFiles extends FileArchivation {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "service_contract_file_seq")
    @SequenceGenerator(name = "service_contract_file_seq", schema = "service_contract", sequenceName = "contract_files_id_seq", allocationSize = 1)
