...
@Repository
public interface ProductPriceComponentRepository extends JpaRepository<ProductPriceComponents, Long> {
    List<ProductPriceComponents> findByProductDetailsIdAndProductSubObjectStatusIn(Long productDetailsId, List<ProductSubObjectStatus> statuses);

    @Query("""
            select distinct pc
            from ProductPriceComponents ppc
            join PriceComponent pc on ppc.priceComponent.id=pc.id
            where ppc.productDetails.id=:productDetailId and ppc.productSubObjectStatus='ACTIVE'
            """)
    List<PriceComponent> findPriceComponentsForProductDetails(Long productDetailId);

    @Query("""
            select distinct ppc.priceComponent.id
            from ProductPriceComponents ppc
            where ppc.productDetails.id=:productdetailid and ppc.productSubObjectStatus='ACTIVE'
             """)
    List<Long> getActivePriceComponentIdsByProductDetailId(
    ...
    @Query(nativeQuery = true, value = """
                ...
                parameter_data as (select pc.id                             as price_component_id,
                                   ...
                                   where pc.id in (select pc_inner.id
                                                   from price_component.price_components pc_inner
                                                            ...
                                                            join product.product_details pd on ppc.product_detail_id = pd.id
                                                            join product_contract.contract_details cd on pd.id = cd.product_detail_id
                                                   ...
                                                   from price_component.price_components pc_inner
                                                            ...
                                                            join product.product_details pd on ppcg.product_detail_id = pd.id
                                                            join product_contract.contract_details cd on pd.id = cd.product_detail_id
                                                            join product_contract.contracts c on cd.contract_id = c.id
                                                   where c.id = :id
                                                     and cd.version_id = :versionId
                ...
                main_query as (select pc.contract_template_tag              as tag,
                               ...
                               from price_component.price_components pc
                                        ...
                                        left join product_contract.contract_price_components cpcx1
                                        ...
                                        left join product_contract.contract_price_components cpcx2
                                        ...
                                        left join product_contract.contract_price_components cpcx3
                                        ...
                                        left join product_contract.contract_price_components cpcx4
                                        ...
                                        left join product_contract.contract_price_components cpcx5
                                        ...
                                        left join product_contract.contract_price_components cpcx6
                                        ...
                                        left join product_contract.contract_price_components cpcx7
                                        ...
                                        left join product_contract.contract_price_components cpcx8
            ...
            from group_query
            """)
    List<PriceComponentResponse> fetchPriceComponentsForDocument(Long id, Integer versionId);
