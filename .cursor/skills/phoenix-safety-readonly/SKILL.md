...
- Never skip **mandated** report-file steps when Rule 30 applies (**`/report`**, **`/feedback`**, or explicit save request); optional post-task disk reports are not required (Rule 0.6).
