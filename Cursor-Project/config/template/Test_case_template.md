...
**Reference:** `.cursor/rules/workspace/test_cases_structure.mdc` (folder layout); `.cursor/commands/test-case-generate.md`; HandsOff Step 3.
...
- **Folder:** Test case files go under `Cursor-Project/test_cases/Flows/<Flow_name>/` or `Cursor-Project/test_cases/Objects/<Entity_name>/` (see `.cursor/rules/workspace/test_cases_structure.mdc`).
