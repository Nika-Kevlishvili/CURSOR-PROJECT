# Epro Splitting Final Create Invoice For Product Contract Price Application Model For Volumes Interim

**Domain:** Billing / Invoicing
**Source:** EPRO - Splitting Final  - create invoice for product contract-Price application model for volumes-Interim.drawio.svg
...
- system should check all valid active in term, active in perpetuity product/service contracts and take respective product/service version
