...
| **Zero_amount_liability_receivable/** | Zero-amount liability/receivable prevention (PDT-2474): manual API rejects zero amount; billing run, invoice cancellation, reversal, credit notes do not persist zero. Files: `Manual_creation.md`, `Billing_and_invoice_flows.md`. |
