...
**Files updated:** `.cursor/rules/main/core_rules.mdc` (Rule 0.8, 0.8.1 wording), `.cursor/rules/safety/safety_rules.mdc` (Rules 7, 31), `.cursor/rules/main/phoenix.mdc` (quick reference).
