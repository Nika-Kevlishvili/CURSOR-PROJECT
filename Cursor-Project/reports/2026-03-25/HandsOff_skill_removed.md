...
2. **Updated** `.cursor/rules/workflows/workflow_rules.mdc` (Rule 37 reference line): removed link to the skill; noted HandsOff is triggered via **/HandsOff**, **!HandsOff**, or the **hands-off** slash command only.
